package com.zking.widget.refreshview;
...
import com.zking.widget.refreshview.observer.EasyDataObserver;

import java.util.ArrayList;

/**
 * Created by Z.king on 2018/3/8.
 */
...
public class RefreshView extends FrameLayout {
    ...
    protected void initAttrs(AttributeSet attrs) {
        TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.RefreshView);
        try {
            mClipToPadding = a.getBoolean(R.styleable.RefreshView_recyclerClipToPadding, false);
            mPadding = (int) a.getDimension(R.styleable.RefreshView_recyclerPadding, -1.0f);
            mPaddingTop = (int) a.getDimension(R.styleable.RefreshView_recyclerPaddingTop, 0.0f);
            mPaddingBottom = (int) a.getDimension(R.styleable.RefreshView_recyclerPaddingBottom, 0.0f);
            mPaddingLeft = (int) a.getDimension(R.styleable.RefreshView_recyclerPaddingLeft, 0.0f);
            mPaddingRight = (int) a.getDimension(R.styleable.RefreshView_recyclerPaddingRight, 0.0f);
            mScrollbarStyle = a.getInteger(R.styleable.RefreshView_scrollbarStyle, -1);
            mScrollbar = a.getInteger(R.styleable.RefreshView_scrollbars, -1);
            mEmptyId = a.getResourceId(R.styleable.RefreshView_layout_empty, 0);
            mProgressId = a.getResourceId(R.styleable.RefreshView_layout_progress, 0);
            mErrorId = a.getResourceId(R.styleable.RefreshView_layout_error, 0);
        } finally {
            a.recycle();
        }
    }
