package com.zking.widget.refreshview.adapter;
...
import com.zking.widget.refreshview.inter.EventDelegateAble;
import com.zking.widget.refreshview.viewHolder.BaseViewHolder;
...
abstract public class RecyclerArrayAdapter<T> extends RecyclerView.Adapter<BaseViewHolder> {
    ...
    private static void log(String content) {
        if (RefreshView.DEBUG) {
            Log.i(RefreshView.TAG, content);
        }
    }
}
